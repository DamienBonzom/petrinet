Contraintes pour le réseau de Petri : 

Petri : 
	Le nom du réseau doit respecter les conventions Java

Liens : 
	Un lien ne peut lier une zone à elle-même
	Il ne peut y avoir deux liens entre les mêmes zones
	Un lien ne peut lier deux zones de même type
