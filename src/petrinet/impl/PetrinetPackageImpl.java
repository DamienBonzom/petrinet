...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 */
	@Override
	public EAttribute getPetri_Nom() {
		return (EAttribute)petriEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getPetri_Elements() {
		return (EReference)petriEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getPetriElement_Petri() {
	...
	public void createPackageContents() {
		...
		createEAttribute(petriEClass, PETRI__NOM);
		createEReference(petriEClass, PETRI__ELEMENTS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPetri_Nom(), ecorePackage.getEString(), "nom", null, 1, 1, Petri.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPetri_Elements(), this.getPetriElement(), null, "elements", null, 0, -1, Petri.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
